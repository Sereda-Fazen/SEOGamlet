...
class VisualCeption extends \Codeception\Module
{
    ...
    /**
     * Event hook before a tests starts
     *
     ...
     *
     * @param string $identifier Identifies your tests object
    ...
    {
        /*
        $caseName = str_replace('Cept.php', '', $this->tests->getFileName());
...
*/
     ...
     *
     * @param $identifier identifies your tests object
